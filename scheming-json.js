...
function schemingJson(exports){
	...
	function exposeAllForTesting(exports) {
		exports['__ALL__'] = {};
		var a = exports['__ALL__'];

		a.parser = parser;
		a.objectParser = objectParser;
		a.arrayParser = arrayParser;
		a.valueParser = valueParser;

		a.parseSpecial 	= parseSpecial;

		a.Failure = Failure;
		a.thunk = thunk;

		// Predicates
		a.isStopValue 	= isStopValue;
		a.isArray		= isArray;
		a.isString 		= isString
		...
		a.isNumber 		= isNumber;
		a.isUndefined 	= isUndefined;
		a.isEmpty 		= isEmpty;
		a.isNonempty 	= isNonempty;
		a.isAnything 	= isAnything;
		a.isSubset 		= isSubset;

		a.composePredicatesWithWrapped = composePredicatesWithWrapped;
		a.composePredicatesWith = composePredicatesWithWrapped;
		...
		a.nand 			= nand;
		a.nor 			= nor;
		a.andWrapped	= andWrapped;
		a.orWrapped 	= orWrapped;

	}

	exposeAllForTesting(exports);
